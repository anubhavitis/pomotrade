    ...
    <div className="flex flex-col justify-center items-center w-full">
      ...
      >
        ...
        <button
          type="submit"
          className={clsx(
            `w-5/6 md:w-36 px-2 rounded-md border-x border-white/5 bg-white/5 hover:bg-emerald-700 hover:text-black transition-colors backdrop-blur-sm h-10 text-white placeholder:text-white/50`,
